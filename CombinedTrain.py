...
from Src.utils.videodataloader import get_vloader
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_model', type=str, default='./Snapshot/SINet_MoCA/')
    ...
    parser.add_argument('--trainv_img_dir', type=str, default='./Dataset/MoCA-Mask/MoCA_Video/TrainDataset_per_sq/')
