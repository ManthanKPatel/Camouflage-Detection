clear; close; clc;
Datasets = {'TestDataset_per_sq'};
salDir = './Result/MoCA_Result/MoCA/'; %MoCA
Results_Save_Path = './Result/MoCA-Mask_eva/';
gtDir = './dataset/MoCA-Mask/MoCA_Video/'; 

Thresholds = 1:-1/255:0;
videoFiles = dir(gtDir);
    
videoNUM = length(videoFiles);
resVideoPath = [salDir '/'];  % video saliency map for evaluated models
...
for videonum = 1:length(Datasets)
    ...
    fileID = fopen([filePath '_' videofolder '_result.txt'], 'w')
